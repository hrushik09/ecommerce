...
class CreatePackedWidthRequestTest {
    ...
    private void hasSingleMessage(Set<ConstraintViolation<CreatePackedWidthRequest>> violations, String message) {
        assertThat(violations).hasSize(1);
        assertThat(violations).extracting("message").contains(message);
    }

    private void hasCountAndMessage(Set<ConstraintViolation<CreatePackedWidthRequest>> violations, int count, String message) {
