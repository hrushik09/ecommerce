...
(
    ...
    packed_weight_value DECIMAL(5, 2) NOT NULL,
    packed_weight_unit  VARCHAR(100)  NOT NULL,
    packed_length_value DECIMAL(5, 2) NOT NULL,
    packed_length_unit  VARCHAR(100)  NOT NULL,
    packed_width_value  DECIMAL(5, 2) NOT NULL,
    packed_width_unit   VARCHAR(100)  NOT NULL,
    packed_height_value DECIMAL(5, 2) NOT NULL,
