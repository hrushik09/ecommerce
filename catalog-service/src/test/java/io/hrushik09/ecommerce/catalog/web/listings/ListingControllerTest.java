    ...
    class GetListings {
        ...
        void shouldGetListingsWhenPageNumberIsSpecified() throws Exception {
            ...
            List<ListingSummary> data = Stream.iterate(11, i -> i < 21, i -> i + 1)
                    .map(i -> new ListingSummary("product_j8ajaj_" + i, "listing_kjbsksfa_" + i, "Title for Listing " + i, i + "9.54", "CAD"))
                    .toList();
            ...
            mockMvc.perform(get("/api/listings?regionCode={regionCode}&page={pageNo}", regionCode, pageNo))
                    ...
                    .andExpect(jsonPath("$.data[0].price", equalTo("119.54")))
                    .andExpect(jsonPath("$.data[0].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[1].price", equalTo("129.54")))
                    .andExpect(jsonPath("$.data[1].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[2].price", equalTo("139.54")))
                    .andExpect(jsonPath("$.data[2].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[3].price", equalTo("149.54")))
                    .andExpect(jsonPath("$.data[3].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[4].price", equalTo("159.54")))
                    .andExpect(jsonPath("$.data[4].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[5].price", equalTo("169.54")))
                    .andExpect(jsonPath("$.data[5].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[6].price", equalTo("179.54")))
                    .andExpect(jsonPath("$.data[6].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[7].price", equalTo("189.54")))
                    .andExpect(jsonPath("$.data[7].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[8].price", equalTo("199.54")))
                    .andExpect(jsonPath("$.data[8].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[9].price", equalTo("209.54")))
                    .andExpect(jsonPath("$.data[9].currency", equalTo("CAD")))
        ...
        void shouldGetListingsWhenPageNumberIsNotSpecified() throws Exception {
            ...
            List<ListingSummary> data = Stream.iterate(1, i -> i < 11, i -> i + 1)
                    .map(i -> new ListingSummary("product_j9u4sbfj_" + i, "listing_kj2asdga_" + i, "Title for Listing " + i, i + "65.76", "CAD"))
                    .toList();
            ...
            mockMvc.perform(get("/api/listings?regionCode={regionCode}", regionCode))
                    ...
                    .andExpect(jsonPath("$.data[0].price", equalTo("165.76")))
                    .andExpect(jsonPath("$.data[0].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[1].price", equalTo("265.76")))
                    .andExpect(jsonPath("$.data[1].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[2].price", equalTo("365.76")))
                    .andExpect(jsonPath("$.data[2].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[3].price", equalTo("465.76")))
                    .andExpect(jsonPath("$.data[3].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[4].price", equalTo("565.76")))
                    .andExpect(jsonPath("$.data[4].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[5].price", equalTo("665.76")))
                    .andExpect(jsonPath("$.data[5].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[6].price", equalTo("765.76")))
                    .andExpect(jsonPath("$.data[6].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[7].price", equalTo("865.76")))
                    .andExpect(jsonPath("$.data[7].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[8].price", equalTo("965.76")))
                    .andExpect(jsonPath("$.data[8].currency", equalTo("CAD")))
                    ...
                    .andExpect(jsonPath("$.data[9].price", equalTo("1065.76")))
                    .andExpect(jsonPath("$.data[9].currency", equalTo("CAD")))
